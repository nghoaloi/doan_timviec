...
<div class="container my-4">
  <h2 class="text-center mb-4">Danh sách công việc và số lượng ứng viên Pending</h2>
  ...
  <table class="table table-bordered mt-3">
    ...
    <tbody>
      ...
      foreach ($jobs as $index => $job) {
          ...
          echo "<td class='text-center'>" . htmlspecialchars($job['Số lượng user Pending']) . "</td>";
          echo "</tr>";
      }
      ?>
    </tbody>
